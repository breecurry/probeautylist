        ...
        <div className="flex items-center justify-center gap-2 my-4">
          {[1, 2, 3].map((s) => (
            <div key={s} className="flex items-center">
              ...
              {s < 3 && <div className={`w-12 h-1 ${step > s ? "bg-rose-500" : "bg-gray-200"}`} />}
            </div>
          ))}
        </div>
            ...
            <Card className="bg-rose-50/50 border-rose-100">
              <CardContent className="p-4 space-y-3">
                ...
                <div className="flex justify-between items-center">
                  ...
                  <span className="font-bold text-lg text-rose-700">${totalPrice.toFixed(2)}</span>
                </div>
                {locationNote && (
            ...
            <div className="space-y-2">
              ...
              {guests.map((guest, index) => (
                <div key={index} className="flex justify-between items-center p-2 bg-white rounded border">
                  ...
                  <span className="text-rose-600 font-medium">{guest.servicePrice}</span>
                </div>
              ))}
            </div>
          </div>
